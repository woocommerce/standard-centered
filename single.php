...
<div id="wrapper">
	<div class="container">
		<div class="row">
			...
			<div id="main" class="<?php echo 'full_width_layout' == $presentation_options['layout'] || get_post_meta( get_the_ID(), 'standard_seo_post_level_layout', true ) ? 'span12 fullwidth' : 'span8 offset2'; ?> clearfix" role="main">
